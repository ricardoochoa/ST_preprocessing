...
We will define our study area with a rectangle, where lower-left is the south-west corner and top-right is the north-east corner of the rectangle. We will use Mexico City for this example. If you are using a different CRS, you will need to define a different **user_crs**.
